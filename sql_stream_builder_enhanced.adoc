...
.. kafka-broker URI = <CLUSTER_HOSTNAME>:9092
...
java -classpath kafka-producer-0.0.1.0.jar producer.KafkaIOTSensorSimulator <CLUSTER_HOSTNAME>:9092 1000
----
...
----
cd /opt/cloudera/parcels/FLINK/lib/flink/examples/streaming
java -classpath kafka-producer-0.0.1.0.jar producer.KafkaLookupWeatherCondition <CLUSTER_HOSTNAME>:9092
----
+
...
Name:           kudu_source
Catalog Type:   Kudu
Kudu Master:    <CLUSTER_HOSTNAME>:7051
----
+
