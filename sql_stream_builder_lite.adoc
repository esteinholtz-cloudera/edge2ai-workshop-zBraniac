...
. On the SSB Explorer, click the three dots next to *Jobs* and select *New Job*:
+
image::images/ssb-create-job.png[width=800]

. In the *Create New Job* window, enter a *Job Name* for your SSB job or use the random name provided. Then click *Create*:
+
