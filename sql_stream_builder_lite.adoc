...
. Now we can look at the data in the Kafka topic by querying the new virtual table.
In the SSB *Explorer*, click the three dots next to *Jobs* and select *New Job*:
+
image::images/ssb-create-job.png[width=800]
...
. After a few seconds you should see the contents of the `sensor6_stats` topic displayed on the *Results* tab.
